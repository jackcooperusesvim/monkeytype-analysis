...
DATAFILENAME = "all_monkeytype.csv"
...
final_data = data[-colemak_filter]



# Uncomment these lines to check the filtering
fig2, ax2 = plt.subplots()
ax2.set_label("cleaned")
plt.scatter(np.array(data.index), data.wpm, c = data.colemak_filter)
plt.show()
